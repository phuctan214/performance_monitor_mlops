...
class MonitoringService:
    ...
    def iterate(self, dataset_name: str, new_rows: pd.DataFrame):
        ...
        logging.info("+" * 20)
        logging.info(self.hash)
        logging.info(self.monitoring)
        logging.info(dataset_name)
        logging.info(self.monitoring['data_car'])
        logging.info(self.column_mapping['data_car'])
        dataset_name = dataset_name.strip()
        self.monitoring[dataset_name].execute(self.reference[dataset_name], current_data,
...
if __name__ == '__main__':
    ...
    SERVICE.iterate(dataset_name="data_car", new_rows=pd.DataFrame([item]))
